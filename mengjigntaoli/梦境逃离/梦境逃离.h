...
struct Bag
{
	struct Good_tool gt[22];//好道具22个
	struct Bad_tool bt[22];//坏道具22个
	int good_tool_gt[22];//好道具下标，可以访问相关图片和信息
	int bad_tool_bt[22];//坏道具下标，可以访问相关图片和信息
};
struct Achievement
{
	int sp;//正数，与成就系统挂钩
